...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-900">Update Informasi Publik {{ $info_publik->title }}</h1>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow mb-4 border-bottom-success shadow">
                <div class="card-body">
                    <form action="{{ route('info-publik.update', $info_publik->id) }}" method="POST">
                        @csrf
                        @method('PATCH')
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="Title"
                                value="{{ old('title', $info_publik->title) }}" required>
                        </div>
                        <div class="form-group">
                            ...
                            @enderror
                            <textarea id="default" name="konten">{{ old('konten', $info_publik->konten) }}</textarea>
                        </div>
